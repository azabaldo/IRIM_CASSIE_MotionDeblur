function [inputs, scores] = run_One_Single(t, xX, vX, xY, vY)
global runInfo
...
%-------------------------Split up trajectories
    ...
    traj_xX = xX(((15-1)*len_segments+1):15*len_segments);
    traj_vX = vX(((15-1)*len_segments+1):15*len_segments);
    traj_xY = xY(((15-1)*len_segments+1):15*len_segments);
    traj_vY = vY(((15-1)*len_segments+1):15*len_segments);
num_segments = 1;
